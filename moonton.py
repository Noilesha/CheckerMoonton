...
# File           : moonton.py                              #
# Author         : Noilesha                                 #
# Github         : https://github.com/Noilesha                #
# Facebook       : https://www.facebook.com/dulahz         #
# Telegram       : https://t.me/Noilesha                     #
# Python version : 3.7++                                   #
############################################################
  ...
  def main(self):
    ...
    if os.path.exists(
      ...
      if len(
        ...
        exit(
          '[!] Empas tidak ada atau tidak valid kalo nulis yg bener kontol pastikan berformat email:pass atau email|pass'
        )
      print(
